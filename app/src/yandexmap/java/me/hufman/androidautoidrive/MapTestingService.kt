...
import me.hufman.androidautoidrive.carapp.maps.YandexMapsController
...
class MapTestingService: Service() {
	...
	private var mapController: YandexMapsController? = null
	...
	private fun createMap(width: Int, height: Int) {
		// Yandex MapKit is initialized by YandexMapKitInitProvider on the application
		// main thread during process startup — do not call MapKitFactory.initialize here.
		...
		val mapController = YandexMapsController(applicationContext, carLocationProvider, virtualDisplay, appSettingsObserver, mapAppMode)
